...
/******/ 	__webpack_require__.p = "/Users/theikkila/code/emblica/react-intro/example/dist";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todomodel = __webpack_require__(1);

	var _todoheader = __webpack_require__(2);

	var _editable = __webpack_require__(160);

	var React = __webpack_require__(3);
	var ReactDOM = __webpack_require__(161);


	var appstate = new _todomodel.TodoData();
	...
	var TaskItem = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var ready = React.createElement('i', { className: task_class + " fa fa-check-circle-o" });
	    return React.createElement(
	      'div',
	      { className: "task " + task_class },
	      React.createElement(
	        'div',
	        { className: 'task-main' },
	        React.createElement(_editable.Editable, { value: this.props.task, onSave: this.save })
	      ),
	      React.createElement(
	        'div',
	        ...
	        React.createElement(
	          'button',
	          { className: 'task-btn remove-btn', onClick: this.remove },
	          React.createElement('i', { className: 'fa fa-times-circle-o' })
	        ),
	        React.createElement(
	          'button',
	          { className: 'task-btn', onClick: this.toggle },
	          ready
	        )
	      )
	    );
	...
	var AddTaskInput = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', value: this.state.task, onChange: this.change, onKeyPress: this.add, placeholder: 'Add task...' })
	    );
	  }
	});

	var TodoList = function TodoList(props) {
	  var filtered_tasks = props.tasks.filter(props.filter).map(function (task) {
	    return React.createElement(TaskItem, { key: task.id, id: task.id, task: task.task, done: task.done });
	  });
	  return React.createElement(
	    'div',
	    { className: "tasks " + props.type },
	    filtered_tasks
	  );
	};
	...
	var TodoApp = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var not_ready_tasks = function not_ready_tasks(task) {
	      return !task.done;
	    };
	    // Only tasks that have been done already
	    var ready_tasks = function ready_tasks(task) {
	      return task.done;
	    };
	    // Actual render
	    return React.createElement(
	      'div',
	      { className: 'todo-app' },
	      React.createElement(AddTaskInput, null),
	      React.createElement(_todoheader.TodoProgressBar, { tasks: all_tasks }),
	      React.createElement(TodoList, { tasks: all_tasks, type: 'not-ready-tasks', filter: not_ready_tasks }),
	      React.createElement(TodoList, { tasks: all_tasks, type: 'ready-tasks', filter: ready_tasks })
	    );
	  }
	});
...
/***/ function(module, exports) {
	...
	var TodoData = exports.TodoData = function () {
	  function TodoData() {
	  ...
	  _createClass(TodoData, [{
	    ...
	    key: "updateTask",
	    value: function updateTask(task_id, updated_task) {
	    ...
	    key: "toggleTask",
	    value: function toggleTask(task_id) {
	      this.state.tasks = this.state.tasks.map(function (task) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoProgressBar = exports.TodoProgressBar = React.createClass({
	  displayName: "TodoProgressBar",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Editable = exports.Editable = React.createClass({
	  ...
	  render: function render() {
	    var editor = React.createElement("input", { className: "update-input", type: "text", value: this.state.value, onChange: this.update, onKeyPress: this.save });
